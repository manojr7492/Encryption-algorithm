...
public class CkSshKey {
  ...
  public boolean LoadText(String path, CkString outStr) {
    return chilkatJNI.CkSshKey_LoadText(swigCPtr, this, path, CkString.getCPtr(outStr), outStr);
  }

  public String loadText(String path) {
    return chilkatJNI.CkSshKey_loadText(swigCPtr, this, path);
  }
  ...
  public boolean SaveText(String strToSave, String path) {
    return chilkatJNI.CkSshKey_SaveText(swigCPtr, this, strToSave, path);
  }
