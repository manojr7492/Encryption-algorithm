...
public class CkGzip {
  ...
  public boolean CompressFileToMem(String srcPath, CkByteData outData) {
    return chilkatJNI.CkGzip_CompressFileToMem(swigCPtr, this, srcPath, CkByteData.getCPtr(outData), outData);
  }

  public boolean CompressMemToFile(CkByteData db, String destPath) {
    return chilkatJNI.CkGzip_CompressMemToFile(swigCPtr, this, CkByteData.getCPtr(db), db, destPath);
  }

  public boolean CompressMemory(CkByteData dbIn, CkByteData outData) {
    return chilkatJNI.CkGzip_CompressMemory(swigCPtr, this, CkByteData.getCPtr(dbIn), dbIn, CkByteData.getCPtr(outData), outData);
  }
  ...
  public boolean DeflateStringENC(String str, String charset, String encoding, CkString outStr) {
    return chilkatJNI.CkGzip_DeflateStringENC(swigCPtr, this, str, charset, encoding, CkString.getCPtr(outStr), outStr);
  }
  ...
  public boolean InflateStringENC(String str, String charset, String encoding, CkString outStr) {
    return chilkatJNI.CkGzip_InflateStringENC(swigCPtr, this, str, charset, encoding, CkString.getCPtr(outStr), outStr);
  }
  ...
  public boolean UnTarGz(String gzPath, String destDir, boolean bNoAbsolute) {
    return chilkatJNI.CkGzip_UnTarGz(swigCPtr, this, gzPath, destDir, bNoAbsolute);
  }
  ...
  public boolean UncompressFileToMem(String srcPath, CkByteData outData) {
    return chilkatJNI.CkGzip_UncompressFileToMem(swigCPtr, this, srcPath, CkByteData.getCPtr(outData), outData);
  }

  public boolean UncompressFileToString(String srcPath, String inCharset, CkString outStr) {
    return chilkatJNI.CkGzip_UncompressFileToString(swigCPtr, this, srcPath, inCharset, CkString.getCPtr(outStr), outStr);
  }

  public String uncompressFileToString(String srcPath, String inCharset) {
    return chilkatJNI.CkGzip_uncompressFileToString(swigCPtr, this, srcPath, inCharset);
  }

  public boolean UncompressMemToFile(CkByteData db, String destPath) {
    return chilkatJNI.CkGzip_UncompressMemToFile(swigCPtr, this, CkByteData.getCPtr(db), db, destPath);
  }

  public boolean UncompressMemory(CkByteData dbIn, CkByteData outData) {
    return chilkatJNI.CkGzip_UncompressMemory(swigCPtr, this, CkByteData.getCPtr(dbIn), dbIn, CkByteData.getCPtr(outData), outData);
  }
