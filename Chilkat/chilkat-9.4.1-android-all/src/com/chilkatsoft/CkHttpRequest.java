...
public class CkHttpRequest {
  ...
  public boolean AddFileForUpload(String name, String path) {
    return chilkatJNI.CkHttpRequest_AddFileForUpload(swigCPtr, this, name, path);
  }

  public boolean AddFileForUpload2(String name, String path, String contentType) {
    return chilkatJNI.CkHttpRequest_AddFileForUpload2(swigCPtr, this, name, path, contentType);
  }
  ...
  public boolean LoadBodyFromFile(String path) {
    return chilkatJNI.CkHttpRequest_LoadBodyFromFile(swigCPtr, this, path);
  }
  ...
  public boolean StreamBodyFromFile(String path) {
    return chilkatJNI.CkHttpRequest_StreamBodyFromFile(swigCPtr, this, path);
  }
