...
public class CkImap {
  ...
  public boolean SendRawCommand(String rawCommand, CkString outRawResponse) {
    return chilkatJNI.CkImap_SendRawCommand(swigCPtr, this, rawCommand, CkString.getCPtr(outRawResponse), outRawResponse);
  }
  ...
  public boolean SetSslClientCertPem(String pemDataOrPath, String pemPassword) {
    return chilkatJNI.CkImap_SetSslClientCertPem(swigCPtr, this, pemDataOrPath, pemPassword);
  }

  public boolean SetSslClientCertPfx(String pfxPath, String pfxPassword) {
    return chilkatJNI.CkImap_SetSslClientCertPfx(swigCPtr, this, pfxPath, pfxPassword);
  }
