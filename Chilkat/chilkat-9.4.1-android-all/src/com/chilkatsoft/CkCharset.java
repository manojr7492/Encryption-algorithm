...
public class CkCharset {
  ...
  public boolean ConvertHtml(CkByteData htmlIn, CkByteData outHtml) {
    return chilkatJNI.CkCharset_ConvertHtml(swigCPtr, this, CkByteData.getCPtr(htmlIn), htmlIn, CkByteData.getCPtr(outHtml), outHtml);
  }
  ...
  public boolean EntityEncodeDec(String inStr, CkString outStr) {
    return chilkatJNI.CkCharset_EntityEncodeDec(swigCPtr, this, inStr, CkString.getCPtr(outStr), outStr);
  }
  ...
  public boolean EntityEncodeHex(String inStr, CkString outStr) {
    return chilkatJNI.CkCharset_EntityEncodeHex(swigCPtr, this, inStr, CkString.getCPtr(outStr), outStr);
  }
  ...
  public boolean GetHtmlCharset(CkByteData htmlData, CkString outCharset) {
    return chilkatJNI.CkCharset_GetHtmlCharset(swigCPtr, this, CkByteData.getCPtr(htmlData), htmlData, CkString.getCPtr(outCharset), outCharset);
  }
  ...
  public String htmlCharset(CkByteData htmlData) {
    return chilkatJNI.CkCharset_htmlCharset(swigCPtr, this, CkByteData.getCPtr(htmlData), htmlData);
  }

  public boolean GetHtmlFileCharset(String htmlPath, CkString outCharset) {
    return chilkatJNI.CkCharset_GetHtmlFileCharset(swigCPtr, this, htmlPath, CkString.getCPtr(outCharset), outCharset);
  }

  public String getHtmlFileCharset(String htmlPath) {
    return chilkatJNI.CkCharset_getHtmlFileCharset(swigCPtr, this, htmlPath);
  }

  public String htmlFileCharset(String htmlPath) {
    return chilkatJNI.CkCharset_htmlFileCharset(swigCPtr, this, htmlPath);
  }

  public boolean HtmlDecodeToStr(String str, CkString outStr) {
    return chilkatJNI.CkCharset_HtmlDecodeToStr(swigCPtr, this, str, CkString.getCPtr(outStr), outStr);
  }
  ...
  public boolean HtmlEntityDecodeFile(String srcPath, String destPath) {
    return chilkatJNI.CkCharset_HtmlEntityDecodeFile(swigCPtr, this, srcPath, destPath);
  }
  ...
  public void SetErrorBytes(SWIGTYPE_p_unsigned_char pByteData, long szByteData) {
    chilkatJNI.CkCharset_SetErrorBytes(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(pByteData), szByteData);
  }
  ...
  public boolean WriteFile(String path, CkByteData dataBuf) {
    return chilkatJNI.CkCharset_WriteFile(swigCPtr, this, path, CkByteData.getCPtr(dataBuf), dataBuf);
  }

  public boolean WriteStringToFile(String str, String path, String charset) {
    return chilkatJNI.CkCharset_WriteStringToFile(swigCPtr, this, str, path, charset);
  }
