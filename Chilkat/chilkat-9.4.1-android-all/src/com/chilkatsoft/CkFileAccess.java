...
public class CkFileAccess {
  ...
  public boolean FileCopy(String existingPath, String newPath, boolean failIfExists) {
    return chilkatJNI.CkFileAccess_FileCopy(swigCPtr, this, existingPath, newPath, failIfExists);
  }

  public boolean FileDelete(String path) {
    return chilkatJNI.CkFileAccess_FileDelete(swigCPtr, this, path);
  }
  ...
  public boolean FileOpen(String path, long accessMode, long shareMode, long createDisp, long attr) {
    return chilkatJNI.CkFileAccess_FileOpen(swigCPtr, this, path, accessMode, shareMode, createDisp, attr);
  }
  ...
  public boolean FileRename(String existingPath, String newPath) {
    return chilkatJNI.CkFileAccess_FileRename(swigCPtr, this, existingPath, newPath);
  }
  ...
  public int FileSize(String path) {
    return chilkatJNI.CkFileAccess_FileSize(swigCPtr, this, path);
  }
  ...
  public boolean ReadBinaryToEncoded(String path, String encoding, CkString outStr) {
    return chilkatJNI.CkFileAccess_ReadBinaryToEncoded(swigCPtr, this, path, encoding, CkString.getCPtr(outStr), outStr);
  }

  public String readBinaryToEncoded(String path, String encoding) {
    return chilkatJNI.CkFileAccess_readBinaryToEncoded(swigCPtr, this, path, encoding);
  }

  public boolean ReadEntireFile(String path, CkByteData outBytes) {
    return chilkatJNI.CkFileAccess_ReadEntireFile(swigCPtr, this, path, CkByteData.getCPtr(outBytes), outBytes);
  }

  public boolean ReadEntireTextFile(String path, String charset, CkString outStrFileContents) {
    return chilkatJNI.CkFileAccess_ReadEntireTextFile(swigCPtr, this, path, charset, CkString.getCPtr(outStrFileContents), outStrFileContents);
  }

  public String readEntireTextFile(String path, String charset) {
    return chilkatJNI.CkFileAccess_readEntireTextFile(swigCPtr, this, path, charset);
  }
  ...
  public boolean WriteEntireFile(String path, CkByteData fileData) {
    return chilkatJNI.CkFileAccess_WriteEntireFile(swigCPtr, this, path, CkByteData.getCPtr(fileData), fileData);
  }

  public boolean WriteEntireTextFile(String path, String fileData, String charset, boolean includePreamble) {
    return chilkatJNI.CkFileAccess_WriteEntireTextFile(swigCPtr, this, path, fileData, charset, includePreamble);
  }
