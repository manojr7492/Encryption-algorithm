...
public class CkRss {
  ...
  public boolean LoadRssFile(String path) {
    return chilkatJNI.CkRss_LoadRssFile(swigCPtr, this, path);
  }
  ...
  public boolean MSetAttr(String tag, int index, String attrName, String value) {
    return chilkatJNI.CkRss_MSetAttr(swigCPtr, this, tag, index, attrName, value);
  }

  public boolean MSetString(String tag, int index, String value) {
    return chilkatJNI.CkRss_MSetString(swigCPtr, this, tag, index, value);
  }
