...
public class CkUnixCompress {
  ...
  public boolean CompressFile(String srcPath, String destPath) {
    return chilkatJNI.CkUnixCompress_CompressFile(swigCPtr, this, srcPath, destPath);
  }

  public boolean CompressFileToMem(String srcPath, CkByteData outData) {
    return chilkatJNI.CkUnixCompress_CompressFileToMem(swigCPtr, this, srcPath, CkByteData.getCPtr(outData), outData);
  }

  public boolean CompressMemToFile(CkByteData db, String destPath) {
    return chilkatJNI.CkUnixCompress_CompressMemToFile(swigCPtr, this, CkByteData.getCPtr(db), db, destPath);
  }

  public boolean CompressMemory(CkByteData dbIn, CkByteData outData) {
    return chilkatJNI.CkUnixCompress_CompressMemory(swigCPtr, this, CkByteData.getCPtr(dbIn), dbIn, CkByteData.getCPtr(outData), outData);
  }
  ...
  public boolean UnTarZ(String zPath, String destDir, boolean bNoAbsolute) {
    return chilkatJNI.CkUnixCompress_UnTarZ(swigCPtr, this, zPath, destDir, bNoAbsolute);
  }

  public boolean UncompressFile(String srcPath, String destPath) {
    return chilkatJNI.CkUnixCompress_UncompressFile(swigCPtr, this, srcPath, destPath);
  }

  public boolean UncompressFileToMem(String srcPath, CkByteData outData) {
    return chilkatJNI.CkUnixCompress_UncompressFileToMem(swigCPtr, this, srcPath, CkByteData.getCPtr(outData), outData);
  }

  public boolean UncompressFileToString(String srcPath, String inCharset, CkString outStr) {
    return chilkatJNI.CkUnixCompress_UncompressFileToString(swigCPtr, this, srcPath, inCharset, CkString.getCPtr(outStr), outStr);
  }

  public String uncompressFileToString(String srcPath, String inCharset) {
    return chilkatJNI.CkUnixCompress_uncompressFileToString(swigCPtr, this, srcPath, inCharset);
  }

  public boolean UncompressMemToFile(CkByteData db, String destPath) {
    return chilkatJNI.CkUnixCompress_UncompressMemToFile(swigCPtr, this, CkByteData.getCPtr(db), db, destPath);
  }

  public boolean UncompressMemory(CkByteData dbIn, CkByteData outData) {
    return chilkatJNI.CkUnixCompress_UncompressMemory(swigCPtr, this, CkByteData.getCPtr(dbIn), dbIn, CkByteData.getCPtr(outData), outData);
  }
