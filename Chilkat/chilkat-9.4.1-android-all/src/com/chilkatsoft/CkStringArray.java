...
public class CkStringArray {
  ...
  public boolean SaveNthToFile(int index, String path) {
    return chilkatJNI.CkStringArray_SaveNthToFile(swigCPtr, this, index, path);
  }
  ...
  public boolean SaveToFile2(String path, String charset) {
    return chilkatJNI.CkStringArray_SaveToFile2(swigCPtr, this, path, charset);
  }
