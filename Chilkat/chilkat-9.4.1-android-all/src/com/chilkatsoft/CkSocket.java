...
public class CkSocket {
  ...
  public boolean AsyncSendBytes(SWIGTYPE_p_unsigned_char pByteData, long szByteData) {
    return chilkatJNI.CkSocket_AsyncSendBytes(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(pByteData), szByteData);
  }
  ...
  public boolean ReceiveBytesToFile(String appendPath) {
    return chilkatJNI.CkSocket_ReceiveBytesToFile(swigCPtr, this, appendPath);
  }
  ...
  public boolean SendBytes(SWIGTYPE_p_unsigned_char pByteData, long szByteData) {
    return chilkatJNI.CkSocket_SendBytes(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(pByteData), szByteData);
  }
  ...
  public boolean SetSslClientCertPem(String pemDataOrPath, String pemPassword) {
    return chilkatJNI.CkSocket_SetSslClientCertPem(swigCPtr, this, pemDataOrPath, pemPassword);
  }

  public boolean SetSslClientCertPfx(String pfxPath, String pfxPassword) {
    return chilkatJNI.CkSocket_SetSslClientCertPfx(swigCPtr, this, pfxPath, pfxPassword);
  }
