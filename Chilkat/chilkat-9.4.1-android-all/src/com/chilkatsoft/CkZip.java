...
public class CkZip {
  ...
  public void get_Proxy(CkString str) {
    chilkatJNI.CkZip_get_Proxy(swigCPtr, this, CkString.getCPtr(str), str);
  }
  ...
  public CkZipEntry AppendBase64(String pathInZip, String data) {
    long cPtr = chilkatJNI.CkZip_AppendBase64(swigCPtr, this, pathInZip, data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public CkZipEntry AppendCompressed(String pathInZip, CkByteData data) {
    long cPtr = chilkatJNI.CkZip_AppendCompressed(swigCPtr, this, pathInZip, CkByteData.getCPtr(data), data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public CkZipEntry AppendData(String pathInZip, CkByteData data) {
    long cPtr = chilkatJNI.CkZip_AppendData(swigCPtr, this, pathInZip, CkByteData.getCPtr(data), data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public CkZipEntry AppendData2(String pathInZip, SWIGTYPE_p_unsigned_char pByteData, long szByteData) {
    long cPtr = chilkatJNI.CkZip_AppendData2(swigCPtr, this, pathInZip, SWIGTYPE_p_unsigned_char.getCPtr(pByteData), szByteData);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }
  ...
  public CkZipEntry AppendHex(String pathInZip, String data) {
    long cPtr = chilkatJNI.CkZip_AppendHex(swigCPtr, this, pathInZip, data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }
  ...
  public CkZipEntry AppendNew(String pathInZip) {
    long cPtr = chilkatJNI.CkZip_AppendNew(swigCPtr, this, pathInZip);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public CkZipEntry AppendNewDir(String pathInZip) {
    long cPtr = chilkatJNI.CkZip_AppendNewDir(swigCPtr, this, pathInZip);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public boolean AppendOneFileOrDir(String path, boolean saveExtraPath) {
    return chilkatJNI.CkZip_AppendOneFileOrDir(swigCPtr, this, path, saveExtraPath);
  }

  public CkZipEntry AppendString(String pathInZip, String str) {
    long cPtr = chilkatJNI.CkZip_AppendString(swigCPtr, this, pathInZip, str);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public CkZipEntry AppendString2(String pathInZip, String str, String charset) {
    long cPtr = chilkatJNI.CkZip_AppendString2(swigCPtr, this, pathInZip, str, charset);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public boolean AppendZip(String zipPath) {
    return chilkatJNI.CkZip_AppendZip(swigCPtr, this, zipPath);
  }
  ...
  public CkZipEntry InsertNew(String pathInZip, int beforeIndex) {
    long cPtr = chilkatJNI.CkZip_InsertNew(swigCPtr, this, pathInZip, beforeIndex);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }
  ...
  public boolean IsPasswordProtected(String zipPath) {
    return chilkatJNI.CkZip_IsPasswordProtected(swigCPtr, this, zipPath);
  }
  ...
  public boolean NewZip(String zipPath) {
    return chilkatJNI.CkZip_NewZip(swigCPtr, this, zipPath);
  }
  ...
  public boolean OpenFromMemory(SWIGTYPE_p_unsigned_char pByteData, long szByteData) {
    return chilkatJNI.CkZip_OpenFromMemory(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(pByteData), szByteData);
  }
  ...
  public boolean QuickAppend(String zipPath) {
    return chilkatJNI.CkZip_QuickAppend(swigCPtr, this, zipPath);
  }
