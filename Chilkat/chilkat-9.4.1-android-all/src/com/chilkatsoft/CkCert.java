...
public class CkCert {
  ...
  public boolean ExportToPfxFile(String pfxPath, String password, boolean bIncludeChain) {
    return chilkatJNI.CkCert_ExportToPfxFile(swigCPtr, this, pfxPath, password, bIncludeChain);
  }
  ...
  public boolean LoadPfxFile(String path, String password) {
    return chilkatJNI.CkCert_LoadPfxFile(swigCPtr, this, path, password);
  }
