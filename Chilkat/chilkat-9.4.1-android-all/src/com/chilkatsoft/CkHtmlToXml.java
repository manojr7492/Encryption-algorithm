...
public class CkHtmlToXml {
  ...
  public boolean ReadFileToString(String path, String srcCharset, CkString outStr) {
    return chilkatJNI.CkHtmlToXml_ReadFileToString(swigCPtr, this, path, srcCharset, CkString.getCPtr(outStr), outStr);
  }

  public String readFileToString(String path, String srcCharset) {
    return chilkatJNI.CkHtmlToXml_readFileToString(swigCPtr, this, path, srcCharset);
  }
  ...
  public boolean SetHtmlFromFile(String path) {
    return chilkatJNI.CkHtmlToXml_SetHtmlFromFile(swigCPtr, this, path);
  }
  ...
  public boolean WriteStringToFile(String str, String path, String charset) {
    return chilkatJNI.CkHtmlToXml_WriteStringToFile(swigCPtr, this, str, path, charset);
  }
