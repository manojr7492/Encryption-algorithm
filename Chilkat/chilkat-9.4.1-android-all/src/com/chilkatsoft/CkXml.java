...
public class CkXml {
  ...
  public boolean ChilkatPath(String cmd, CkString outStr) {
    return chilkatJNI.CkXml_ChilkatPath(swigCPtr, this, cmd, CkString.getCPtr(outStr), outStr);
  }

  public String chilkatPath(String cmd) {
    return chilkatJNI.CkXml_chilkatPath(swigCPtr, this, cmd);
  }
  ...
  public boolean LoadXmlFile(String path) {
    return chilkatJNI.CkXml_LoadXmlFile(swigCPtr, this, path);
  }

  public boolean LoadXmlFile2(String path, boolean autoTrim) {
    return chilkatJNI.CkXml_LoadXmlFile2(swigCPtr, this, path, autoTrim);
  }
  ...
  public boolean SaveBinaryContent(String path, boolean unzipFlag, boolean decryptFlag, String password) {
    return chilkatJNI.CkXml_SaveBinaryContent(swigCPtr, this, path, unzipFlag, decryptFlag, password);
  }
  ...
  public boolean SaveXml(String path) {
    return chilkatJNI.CkXml_SaveXml(swigCPtr, this, path);
  }
  ...
  public boolean SetBinaryContent(CkByteData data, boolean zipFlag, boolean encryptFlag, String password) {
    return chilkatJNI.CkXml_SetBinaryContent(swigCPtr, this, CkByteData.getCPtr(data), data, zipFlag, encryptFlag, password);
  }
  ...
  public boolean SetBinaryContentFromFile(String path, boolean zipFlag, boolean encryptFlag, String password) {
    return chilkatJNI.CkXml_SetBinaryContentFromFile(swigCPtr, this, path, zipFlag, encryptFlag, password);
  }
