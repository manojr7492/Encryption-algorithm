...
public class CkHtmlToText {
  ...
  public boolean ReadFileToString(String path, String srcCharset, CkString outStr) {
    return chilkatJNI.CkHtmlToText_ReadFileToString(swigCPtr, this, path, srcCharset, CkString.getCPtr(outStr), outStr);
  }

  public String readFileToString(String path, String srcCharset) {
    return chilkatJNI.CkHtmlToText_readFileToString(swigCPtr, this, path, srcCharset);
  }
  ...
  public boolean WriteStringToFile(String str, String path, String charset) {
    return chilkatJNI.CkHtmlToText_WriteStringToFile(swigCPtr, this, str, path, charset);
  }
