...
public class CkRsa {
  ...
  public boolean DecryptBytes(CkByteData bData, boolean bUsePrivateKey, CkByteData outData) {
    return chilkatJNI.CkRsa_DecryptBytes(swigCPtr, this, CkByteData.getCPtr(bData), bData, bUsePrivateKey, CkByteData.getCPtr(outData), outData);
  }
  ...
  public boolean DecryptString(CkByteData bData, boolean bUsePrivateKey, CkString outStr) {
    return chilkatJNI.CkRsa_DecryptString(swigCPtr, this, CkByteData.getCPtr(bData), bData, bUsePrivateKey, CkString.getCPtr(outStr), outStr);
  }

  public String decryptString(CkByteData bData, boolean bUsePrivateKey) {
    return chilkatJNI.CkRsa_decryptString(swigCPtr, this, CkByteData.getCPtr(bData), bData, bUsePrivateKey);
  }
  ...
  public boolean EncryptBytes(CkByteData bData, boolean bUsePrivateKey, CkByteData outData) {
    return chilkatJNI.CkRsa_EncryptBytes(swigCPtr, this, CkByteData.getCPtr(bData), bData, bUsePrivateKey, CkByteData.getCPtr(outData), outData);
  }

  public boolean EncryptBytesENC(CkByteData bData, boolean bUsePrivateKey, CkString outStr) {
    return chilkatJNI.CkRsa_EncryptBytesENC(swigCPtr, this, CkByteData.getCPtr(bData), bData, bUsePrivateKey, CkString.getCPtr(outStr), outStr);
  }

  public String encryptBytesENC(CkByteData bData, boolean bUsePrivateKey) {
    return chilkatJNI.CkRsa_encryptBytesENC(swigCPtr, this, CkByteData.getCPtr(bData), bData, bUsePrivateKey);
  }
  ...
  public boolean SignBytes(CkByteData bData, String hashAlg, CkByteData outData) {
    return chilkatJNI.CkRsa_SignBytes(swigCPtr, this, CkByteData.getCPtr(bData), bData, hashAlg, CkByteData.getCPtr(outData), outData);
  }

  public boolean SignBytesENC(CkByteData bData, String hashAlg, CkString outStr) {
    return chilkatJNI.CkRsa_SignBytesENC(swigCPtr, this, CkByteData.getCPtr(bData), bData, hashAlg, CkString.getCPtr(outStr), outStr);
  }
  ...
  public boolean SnkToXml(String snkPath, CkString outStr) {
    return chilkatJNI.CkRsa_SnkToXml(swigCPtr, this, snkPath, CkString.getCPtr(outStr), outStr);
  }

  public String snkToXml(String snkPath) {
    return chilkatJNI.CkRsa_snkToXml(swigCPtr, this, snkPath);
  }
